...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'cmoorecurrier';//this will be your WCC username
      $dbUsr = 'cmoorecurrier';//this will be your WCC username
      $dbPass = 'UIYoXqCQc8NkuGp';//this will be the password found in the video.
